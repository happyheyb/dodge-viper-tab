var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/dodge-viper-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/dodge-viper-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/dodge-viper-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/dodge-viper-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Dodge Viper?",
				description: "Get awesome Dodge Viper HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
